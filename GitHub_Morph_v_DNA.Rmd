...
species_visual <- ggplot(Chunk, 
       aes(x = factor(Shark_species),
           fill = factor(lowest_visual, 
                         levels = c("Subphylum", "Subclass", "Infraclass", "Order", "Infraorder", "Family", "Genus", "Species", "NA"),
                         labels = c("Subphylum", "Subclass", "Infraclass", "Order", "Infraorder", "Family", "Genus", "Species", "NA")))) + 
  ...
  labs(y = "Percent of prey taxa identified", 
       ...
       x = "Shark species") +
  theme_classic() +
    scale_fill_manual(values = c("royalblue", "indianred4", "#d7b5d8", "aquamarine4","salmon", "darkolivegreen3", "khaki", "lightblue", "grey")) +
